...
public class AppointmentServiceImpl extends BaseServiceImpl implements AppointmentService {
  ...
  public List<Appointment> getOpenAppointments() {
    return appointmentRepository.findByAppointmentStatusTypeOrderByAppointmentDateDesc(
        AppointmentStatusType.OPEN);
  }

  public List<Appointment> getOpenAppointmentsForEmployee(Employee emp) {
    return appointmentRepository.findByEmployeeOrderByAppointmentDateDescAppointmentStatusTypeDesc(
        emp);
  }
