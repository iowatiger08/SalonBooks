...
public class OrderItem implements Serializable {
    ...
    @Transient
    public Order getOrder() { return pk.getOrder(); }
    public void setOrder(Order order) { pk.setOrder(order); }

    @Transient
    public Item getItem() { return pk.getItem(); }
    public void setItem(Item item) { pk.setItem(item); }
